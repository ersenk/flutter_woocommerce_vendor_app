...
class HorizontalBarChart extends StatelessWidget {
  ...
  List<CartesianSeries> getChartsOnType(ChartType chartType) {
    switch (chartType) {
  ...
  List<CartesianSeries> getDefaultData() {
  ...
  List<CartesianSeries> getDefaultData2() {
    ...
    print("from : getDefaultData2: seriesList ${seriesList.length} chartData ${chartData.length}");
    return <CartesianSeries>[
...
print("from : getDefaultData3: seriesList ${seriesList.length} chartData ${chartData.length}");
    return <CartesianSeries>[
