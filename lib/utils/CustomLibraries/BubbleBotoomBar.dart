...
class _BottomNavigationTile extends StatelessWidget {
  const _BottomNavigationTile(this.item, this.opacity, this.animation, this.iconSize, {this.onTap, this.colorTween, this.flex, this.selected = false, this.indexLabel, this.ink = false, this.inkColor}) : assert(selected != null);
...
BubbleBottomBarItem tab(var iconData, String tabName) {
  return BubbleBottomBarItem(
      backgroundColor: primaryColor, icon: Image.asset(iconData, color: appStore.iconColor, height: 20, width: 20), activeIcon: Image.asset(iconData, color: primaryColor, height: 20, width: 20), title: Text(tabName, style: TextStyle(fontSize: 16)));
}
